...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("d3d_render_tip", "Ob vklopljenem D3D upodabljanju, lahko na nekaterih računalnikih postane zaslon oddaljenega nadzora črn."),
        ("Use D3D rendering", "Uporabi D3D upodabljanje"),
        ("Printer", "Tiskalnik"),
        ("printer-os-requirement-tip", "Tiskanje zahteva Windows 10 ali novejšo različico"),
        ("printer-requires-installed-{}-client-tip", "Za uporabo oddaljenega tiskanja morate na tej napravi namestiti {}."),
        ("printer-{}-not-installed-tip", "Tiskalnik {} ni nameščen."),
        ("printer-{}-ready-tip", "Tiskalnik {} je nameščen in pripravljen na uporabo."),
        ("Install {} Printer", "Namesti tiskalnik {}"),
        ("Outgoing Print Jobs", "Odhodni tiskalniški posli"),
        ("Incoming Print Jobs", "Dohodni tiskalniški posli"),
        ("Incoming Print Job", "Dohodni tiskalniški posel"),
        ...
        ("print-incoming-job-confirm-tip", "Prejeli ste tiskalniški posel iz oddaljenega računalnika. Ali ga želite natisniti lokalno?"),
        ("remote-printing-disallowed-tile-tip", "Oddaljeno tiskanje ni dovoljeno"),
        ("remote-printing-disallowed-text-tip", "Varnostne nastavitve oddaljenega računalnika ne dovoljujejo tiskanja."),
        ("save-settings-tip", "Shrani nastavitve"),
        ("dont-show-again-tip", "Ne prikaži znova"),
        ("Take screenshot", "Naredi posnetek zaslona"),
        ("Taking screenshot", "Izdelava posnetka zaslona"),
        ("screenshot-merged-screen-not-supported-tip", "Združevanje posnetkov večih zaslonov trenutno ni podprto. Preklopite na prikaz enega zaslona in poizkusite znova."),
        ("screenshot-action-tip", "Izberite, kaj narediti s posnetkom zaslona"),
        ("Save as", "Shrani kot"),
        ...
        ("download-new-version-failed-tip", "Prenos ni uspel. Lahko poizkusite ponovno, ali pa kliknete gumb »Prenesi« za prenos programa iz domače strani, in nato nadgradite ročno."),
        ("Auto update", "Samodejna posodobitev"),
        ("update-failed-check-msi-tip", "Preverjanje vrste namestitve ni uspelo. Kliknite gumb »Prenesi« za prenos programa iz domače strani, in nato nadgradite ročno."),
        ("websocket_tip", "Pri uporabi WebSocketov so možne samo povezave s posrednikom."),
        ("Use WebSocket", "Uporabi WebSocket"),
        ("Trackpad speed", "Hitrost drsne ploščice"),
        ("Default trackpad speed", "Privzeta hitrost drsne ploščice"),
        ("Numeric one-time password", "Številčno enkratno geslo"),
        ("Enable IPv6 P2P connection", "Omogoči IPv6 P2P povezavo"),
        ("Enable UDP hole punching", "Omogoči UDP luknjanje"),
        ("View camera", "Pogled kamere"),
        ("Enable camera", "Omogoči kamero"),
        ("No cameras", "Ni kamer"),
        ("view_camera_unsupported_tip", "Oddaljena naprava ne omogoča gledanja kamere."),
        ("Terminal", "Terminal"),
        ("Enable terminal", "Omogoči termninal"),
        ("New tab", "Nov zavihek"),
        ("Keep terminal sessions on disconnect", "Ohrani terminalske povezave ob odklopu"),
        ("Terminal (Run as administrator)", "Terminal (zaženi kot skrbnik)"),
        ("terminal-admin-login-tip", "Vnesite skrbniško uporabniško ime in geslo za nadzorovani računalnik"),
        ("Failed to get user token.", "Ni bilo mogoče dobiti uporabniškega žetona."),
        ("Incorrect username or password.", "Nepravilno uporabniško ime ali geslo."),
        ("The user is not an administrator.", "Uporabnik nima skrbniških pravic."),
        ("Failed to check if the user is an administrator.", "Ni bilo mogoče preveriti, če ima uporabnik skrbniške pravice."),
